...
state_data <- data.frame(
  ...
  nickname = c("Alabamian", "Alaskan", "Arizonan", "Arkansan", "Californian", 
               "Coloradan", "Connecticuter", "Delawarean", "Floridian", "Georgian", 
               "Hawaiian", "Idahoan", "Illinoisan", "Indianan", "Iowan", "Kansasan", 
               "Kentuckian", "Louisianan", "Mainer", "Marylander", "Massachusettsan", 
               "Michigander", "Minnesotan", "Mississippian", "Missourian", "Montanan", 
               "Nebraskan", "Nevadan", "New Hampshirite", "New Jerseyan", "New Mexican", 
               "New Yorker", "North Carolinian", "North Dakotan", "Ohioan", 
               "Oklahoman", "Oregonian", "Pennsylvanian", "Rhode Islander", 
               "South Carolinian", "South Dakotan", "Tennessean", "Texan", "Utahan", 
               "Vermonter", "Virginian", "Washingtonian", "West Virginian", 
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      div(class = "circle-info",
          ...
          tags$p("This app provides information on vaccination coverage in the U.S. ",
                 "for different vaccines, including HPV, Tetanus, MenACWY, and seasonal ",
                 "influenza. It shows the vaccination rates for individuals aged 13-17 years ",
                 "by state."),
          tags$h4("Why is this important?"),
          tags$p("Vaccination plays a crucial role in public health by preventing the ",
                 "spread of infectious diseases. Monitoring vaccination coverage helps ",
                 "identify areas where further efforts are needed to ensure widespread ",
                 "protection against diseases like HPV, Tetanus, MenACWY, and influenza.")
      )
    ),
